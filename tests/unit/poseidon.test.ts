...
describe('Poseidon Hash Implementation', () => {
    ...
    describe('Commitment Generation', () => {
        it('Should generate valid commitments', async () => {
            ...
            const commitment = await PoseidonHasher.computeCommitment(secret, nullifier);
        ...
        it('Should generate different commitments for different inputs', async () => {
            ...
            const commitment1 = await PoseidonHasher.computeCommitment(secret1, nullifier);
            const commitment2 = await PoseidonHasher.computeCommitment(secret2, nullifier);
