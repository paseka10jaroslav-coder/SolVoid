// Simple Poseidon test for cross-component verification
...
fn test_poseidon_hash_simple() {
    ...
    let poseidon_params = ark_crypto_primitives::sponge::poseidon::PoseidonConfig::new(
        2,  // rate
        1,  // capacity
        1,  // alpha
        5,  // full rounds
    ...
    let mut poseidon = PoseidonSponge::<Bn254>::new(&poseidon_params);
    ...
    match inputs.as_slice() {
        ...
        _ => {
            ...
            let mut poseidon2 = PoseidonSponge::<Bn254>::new(&poseidon_params);
